...
# Datos red
$vnetName               = "win10mvsred"
$vnetPrefix             = "10.0.10.0/16"
$subnetName             = "win10mvssubred"
$subnetPrefix           = "10.0.10.0/24"

# Datos almacenamiento
$stdStorageAccountName = "win10mvsalma"
...
$nsg = New-AzureRmNetworkSecurityGroup -Name win10mvseg -ResourceGroupName $rgName -Location $location -SecurityRules $regla3389
